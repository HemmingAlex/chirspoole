    ...
    >
      ...
      <div className="h-screen flex items-center justify-center">
        <div className="flex flex-col items-center relative bottom-10 space-y-2">
          <div
            className="text-purple-600 font-semibold px-3 py-2 rounded-md transition-colors text-[7vw] sm:text-[5vw] md:text-[2.5vw] lg:text-[1.8vw] xl:text-[1.8vw] mb-2"
          >
            Menu
          </div>
          ...
          {menuItems.map((item) => (
            <Link
              key={item.href}
              href={item.href}
              className={`font-semibold px-3 py-1.5 rounded-md hover:bg-gray-700/50 transition-colors text-[6vw] sm:text-[4vw] md:text-[2.2vw] lg:text-[1.5vw] xl:text-[1.5vw] w-full text-center ${
