...
export default function WeddingsPage() {
  ...
  const CeremonyContent = () => (
    <div className="text-gray-700 text-lg">
      ...
      <div className="mt-6">
        <p className="font-semibold text-lg mb-2 text-purple-800">Services Offered for The Ceremony:</p>
        <ul className="grid grid-cols-2 gap-2 mt-3">
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>Choir</li>
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>Violinist</li>
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>String quartet</li>
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>Harpist</li>
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>Organist/Pianist</li>
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>Guitarist</li>
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>Vocalists</li>
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>Duos</li>
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>Trios</li>
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>Ensembles</li>
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>Orchestra</li>
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>Performers & Animal releases</li>
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>Customized Playlists</li>
        </ul>
      </div>
    </div>
  );
  ...
  const ReceptionContent = () => (
    <div className="text-gray-700 text-lg">
      ...
      <div className="mt-6">
        <p className="font-semibold text-lg mb-2 text-purple-800">Services Offered:</p>
        <ul className="grid grid-cols-2 gap-2 mt-3">
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>Solo performers (Guitarist, Pianist, Violinist, etc.)</li>
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>Jazz bands or ensembles</li>
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>Acoustic duos or trios</li>
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>Performers/Fire/Statues</li>
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>Magicians</li>
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>Children's Entertainment</li>
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>Giant Garden Games</li>
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>Cocktail flair bartending</li>
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>Custom playlists for a relaxed vibe</li>
        </ul>
      </div>
    </div>
  );
  ...
  const DinnerContent = () => (
    <div className="text-gray-700 text-lg">
      ...
      <div className="mt-6">
        <p className="font-semibold text-lg mb-2 text-purple-800">Services Offered:</p>
        <ul className="grid grid-cols-2 gap-2 mt-3">
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>Singing Waiters</li>
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>Solo musicians (Pianist, Guitarist, Harpist, etc.)</li>
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>Jazz bands or String Quartets</li>
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>Speciality performers</li>
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>Duos/Trios</li>
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>Full Party Band in-between Courses</li>
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>Classical or Contemporary Ensembles</li>
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>Custom playlists for the dinner mood</li>
        </ul>
      </div>
    </div>
  );
  ...
  const EveningContent = () => (
    <div className="text-gray-700 text-lg">
      ...
      <div className="mt-6">
        <p className="font-semibold text-lg mb-2 text-purple-800">Services Offered:</p>
        <ul className="grid grid-cols-2 gap-2 mt-3">
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>5–36-piece Live band</li>
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>Professional DJ with customized playlists</li>
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>Solo musicians for more intimate vibes</li>
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>Interactive entertainment (live karaoke, photo booths, etc.)</li>
          <li className="flex items-center"><span className="h-2 w-2 rounded-full bg-purple-500 mr-2"></span>First dance with Live Band or Musicians</li>
        </ul>
      </div>
    </div>
  );
